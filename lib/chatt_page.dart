      ...
      leading: Align(
        ...
        child: Padding(
          ...
          child: GestureDetector(
            onTap: (){
    Navigator.push(context,MaterialPageRoute(builder: (context)=>ChattPagee()));
    },
          ...
          actions: [
            Padding(
              padding: const EdgeInsets.only(top: 18.36,bottom: 18.36,right: 167.5,left: 127.5),
    ...
    Navigator.push(context, MaterialPageRoute(builder: (context)=>ChatHistory()));
            ...
            child: Align(
              ...
              child: Column(
                children: [
                  ...
                  Text('Empower Your Spiritual Journey with Church',
                    style: TextStyle(
                      fontSize: 17,
                  ...
                  Text('AI’s Transformative Support',
                  style: TextStyle(
                    fontSize: 17,
                    fontWeight: FontWeight.w400,
                      color: Color(0xFF6C7275)
                   ...
                   children: [
                     Expanded(
                       child: Padding(
                         ...
                         child: Container(
                           ...
                           child: Center(
                             child: Text('Who is the organizer of the Wine Press Conference?',
                               style: TextStyle(
                                 fontWeight: FontWeight.w400,
                                 fontSize: 12,
                               ),
                     ...
                     Expanded(
                       child: Container(
                         ...
                         child: Center(
                           child: Text('Where is the venue of the Wine Press Conference?',
                             style: TextStyle(
                               fontWeight: FontWeight.w400,
                               fontSize: 12,
                             ),
            ...
            children: [
              Expanded(
                child: Padding(
                  ...
                  child: Container(
                    ...
                    child: Center(
                      child: Text('When does the Wine Press Conference start and end?',
                        style: TextStyle(
                          fontWeight: FontWeight.w400,
                          fontSize: 12,
                        ),
              ...
              Expanded(
                child: Container(
                  ...
                  child: Center(
                    child: Text('Give me a detailed explanation of faith',
                      style: TextStyle(
                        fontWeight: FontWeight.w400,
                        fontSize: 12,
                      ),
      ...
      BottomNavigationBar(
        items: <BottomNavigationBarItem>[
          ...
          BottomNavigationBarItem(icon:Icon(Icons.add_card_rounded),
              label: 'Billing'
          ),
